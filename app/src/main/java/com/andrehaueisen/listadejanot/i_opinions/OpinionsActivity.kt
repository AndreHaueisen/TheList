...
import com.andrehaueisen.listadejanot.i_opinions.dagger.DaggerOpinionsComponent
...
import kotlinx.android.synthetic.main.i_activity_opinions.*
...
class OpinionsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.i_activity_opinions)
