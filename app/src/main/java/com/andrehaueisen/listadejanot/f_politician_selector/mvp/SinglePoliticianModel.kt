...
class SinglePoliticianModel(private val mFirebaseRepository: FirebaseRepository,
    ...
    fun updateGrade(voteType: RatingBarType, outdatedGrade: Float, newGrade: Float, politician: Politician) {
        val userEmail = mFirebaseAuthenticator.getUserEmail()!!
        mFirebaseRepository.handleGradeChange(voteType, outdatedGrade, newGrade, politician, userEmail)
    }
