...
class Constants{
    ...
    companion object{
        ...
        //TODO errase once authetication is implementd
        @JvmField val FAKE_USER_EMAIL = "fakeEmailUser@ba.com"
        ...
        @JvmField val BUNDLE_POLITICIAN = "politician"

        @JvmField val LOCATION_UID_MAPPINGS = "UID_mappings"
        @JvmField val LOCATION_USERS_DATA = "Users_data"
        ...
        @JvmField val LOCATION_USERS_CONDEMNATIONS = "Users_condemnations"
